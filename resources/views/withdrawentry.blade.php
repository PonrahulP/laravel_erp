...
<div class="container mt-5">
        <div class="row">
            <h5><a href="{{route('withdrawreport')}}" style="text-decoration:none;"><i class="bi bi-journal-richtext"></i> Bank To Cash Report</a></h5>
            <hr>
            <nav class="my-3">
                <ol class="breadcrumb">
            ...
            <div class="col-md-8">
                <form action="{{route('withdrawinsert')}}" method="POST">
                @if(Session::has('success'))
                    ...
                    <div class="row mb-3">
                        <div class="col-md-12">
                            ...
                            <input type="text" name="name" id="name" style="border-color:black;" class="form-control" placeholder="Enter Bank Name" value="{{old('name')}}">
